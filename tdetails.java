...
public class tdetails extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
	{
		...
		//returns the object of PrintWriter Class,in which print(String args) method is declared to print any thing on 
		//the browser's page as a response.
		...
		try
		{
			...
			if (conn != null) 
			{
				...
				if(tshirtAccessories!=null && tshirtTagLine!=null && tshirtOption!=null && tcolor!=null)
				{
					...
					//Insert statement
					qu="insert into tee values(99,'"+tshirtTagLine+"','"+tshirtAccessories+"','"+tcolor+"','"+tshirtOption+"');";
